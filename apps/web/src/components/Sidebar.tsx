...
export function Sidebar({ mobileOpen, onMobileClose, isMobile }: SidebarProps) {
  ...
  if (isMobile) {
    ...
    return (
      <>
        {/* Backdrop */}
        {mobileOpen && (
          <div className="drawer-backdrop" onClick={onMobileClose} aria-hidden="true" />
        )}
  ...
  const sidebarStyle: CSSProperties = {
    ...
    flexDirection: 'column',
    transition:
      'width 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94), min-width 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94)',
    overflow: 'hidden',
    position: 'fixed',
    top: 0,
    left: 0,
