...
// Motivos selecionaveis manualmente (PURCHASE/SALE sao gerados pelo sistema)
  ...
  const columns: DataTableColumn<MovementRow>[] = useMemo(
    () => [
        ...
        render: (row) => (
          <span
            style={{
              ...
              backgroundColor:
                row.direction === 'IN' ? 'var(--color-success-100)' : 'var(--color-danger-100)',
              color:
                row.direction === 'IN' ? 'var(--color-success-700)' : 'var(--color-danger-700)',
            }}
          >
      ...
      },
      {
        ...
        header: 'Motivo',
        width: '130px',
        render: (row) => REASON_MAP[row.reasonType] ?? row.reasonType,
      },
      {
        key: 'notes',
        header: 'Obs',
    ...
    try {
      await apiClient('/inventory/movements', {
        ...
        body: {
          ...
          qtyBase: parseInt(newQty, 10),
          reasonType: newReason,
          notes: newNotes || null,
        },
      })
      setShowModal(false)
          ...
          >
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <div>
                  ...
                  <select
                    ...
                    style={{ ...inputStyle, cursor: 'pointer' }}
                  >
                    {Object.entries(MANUAL_REASONS).map(([k, v]) => (
              ...
              >
                ...
                <button
                  onClick={handleSave}
                  disabled={saving || !newProductId || !newQty}
                  style={{
                    padding: '10px 16px',
                    fontSize: 'var(--font-sm)',
                    fontWeight: 600,
