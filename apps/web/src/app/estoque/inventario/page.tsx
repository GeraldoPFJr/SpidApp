...
export default function InventarioPage() {
  ...
  const miniInputStyle: CSSProperties = {
    padding: '8px 12px', fontSize: 'var(--font-sm)', color: 'var(--color-neutral-800)',
    backgroundColor: 'var(--color-white)', border: '1px solid var(--color-neutral-300)',
    borderRadius: 'var(--radius-md)', outline: 'none', width: '120px', textAlign: 'right',
  }
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '800px' }}>
        ...
        <div style={cardStyle}>
          ...
          <select
            ...
            style={{ padding: '8px 12px', fontSize: 'var(--font-sm)', color: 'var(--color-neutral-800)', backgroundColor: 'var(--color-white)', border: '1px solid var(--color-neutral-300)', borderRadius: 'var(--radius-md)', outline: 'none', cursor: 'pointer', width: '100%', maxWidth: '400px' }}
          >
