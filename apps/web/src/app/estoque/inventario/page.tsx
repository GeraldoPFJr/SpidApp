      ...
      await apiClient('/inventory/count', {
        ...
        body: {
          items: validCounts.map((c) => ({
            ...
            countedQtyBase: parseInt(c.counted, 10),
          })),
        },
      })
                ...
                {counts.map((c) => (
                  ...
                  >
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
                      <div>
                        <span
                          style={{ fontSize: 'var(--font-xs)', color: 'var(--color-neutral-500)' }}
                        >
                          Saldo Sistema
                        </span>
                        <div style={{ fontWeight: 600, color: 'var(--color-neutral-700)' }}>
                          {c.systemStock.toLocaleString('pt-BR')}
                        </div>
                      </div>
                      <div>
                        <span
                    ...
                    >
                      ...
                      {c.counted === ''
                        ? '-'
                        : (c.difference > 0 ? '+' : '') + c.difference.toLocaleString('pt-BR')}
                    </div>
                  </div>
                ))}
              </div>
