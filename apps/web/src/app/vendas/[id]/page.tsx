...
export default function VendaDetalhePage() {
  ...
  const handleCancel = async () => {
    ...
    try {
      await apiClient(`/sales/${id}/cancel`, {
        method: 'POST',
        body: {
          merchandiseAction: cancelMerchandise,
          moneyAction: cancelMoney,
          merchandiseNotes: cancelNotes || undefined,
          moneyNotes: cancelNotes || undefined,
        },
      })
    ...
    return (
      <Layout>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <div
            className="skeleton"
            style={{ height: '32px', width: isMobile ? '200px' : '300px' }}
          />
  ...
  const st = statusMap[computedPaymentStatus] ?? {
    label: 'Paga',
    ...
    <Layout>
      ...
      >
        ...
        <div style={cardStyle}>
          ...
          >
            <div>
              <p style={infoLabelStyle}>Cliente</p>
              <p style={infoValueStyle}>{sale.customerName ?? 'Consumidor Final'}</p>
            </div>
            <div>
              <p style={infoLabelStyle}>Data</p>
              <p style={infoValueStyle}>{formatDateTime(sale.date)}</p>
            </div>
            <div>
              <p style={infoLabelStyle}>Subtotal</p>
              <p style={infoValueStyle}>{formatCurrency(sale.subtotal)}</p>
            </div>
            {sale.discount > 0 && (
              <div>
                <p style={infoLabelStyle}>Desconto</p>
                <p style={{ ...infoValueStyle, color: 'var(--color-success-600)' }}>
            ...
            {sale.freight > 0 && (
              <div>
                <p style={infoLabelStyle}>Frete</p>
                <p style={infoValueStyle}>+ {formatCurrency(sale.freight)}</p>
              </div>
            )}
            <div>
              <p style={infoLabelStyle}>Total</p>
              <p style={{ ...infoValueStyle, fontSize: '1.25rem', fontWeight: 700 }}>
        ...
        <div style={cardStyle}>
          ...
          {isMobile ? (
            ...
            >
              <table
                style={{ width: '100%', borderCollapse: 'collapse', fontSize: 'var(--font-sm)' }}
              >
                <thead>
                  <tr>
                    ...
                    <React.Fragment key={rec.id}>
                      <div
                        style={{
                          ...
                          backgroundColor:
                            payingId === rec.id ? 'var(--color-success-50)' : 'var(--color-white)',
                        }}
                      >
                        <div
                          style={{
                        ...
                        {payingId === rec.id ? (
                          <div
                            style={{
                              borderTop: '1px solid var(--color-success-200)',
                              paddingTop: '10px',
                              display: 'flex',
                              flexDirection: 'column',
                              gap: '8px',
                          ...
                          >
                            ...
                            >
                              <div>
                                ...
                                <input
                                  ...
                                  style={{ ...payFormInputStyle, width: '100%' }}
                                />
                              </div>
                              <div>
                                <label
                            ...
                            >
                              <div>
                                ...
                                <select
                                  ...
                                  style={{ ...payFormInputStyle, cursor: 'pointer', width: '100%' }}
                                >
                                  {Object.entries(payMethodLabels).map(([k, v]) => (
                            ...
                            <div style={{ display: 'flex', gap: '8px' }}>
                              ...
                              <button
                                ...
                                disabled={paySaving || !payAccountId}
                                style={{
                                  flex: 1,
                                  padding: '10px',
                                  fontSize: 'var(--font-xs)',
                      ...
                      {['Vencimento', 'Tipo', 'Valor', 'Status', ''].map((h, i) => (
                        <th
                          ...
                          style={{
                            ...
                            letterSpacing: '0.05em',
                            width:
                              i === 4 ? '90px' : i === 3 ? '100px' : i === 2 ? '130px' : '120px',
                          }}
                        >
                          {h}
                        </th>
                          ...
                          <tr>
                            <td
                              style={{
                                padding: '10px 16px',
                                borderBottom: '1px solid var(--color-neutral-100)',
                                color: overdue ? 'var(--color-danger-600)' : undefined,
                                fontWeight: overdue ? 600 : 400,
                              }}
                            >
                            ...
                            <tr>
                              <td
                                ...
                                style={{
                                  padding: '12px 16px',
                                  backgroundColor: 'var(--color-success-50)',
                                  borderBottom: '1px solid var(--color-success-100)',
                                }}
                              >
                                {payError && (
                                  <div
                                ...
                                >
                                  <div>
                                    ...
                                    <input
                                      ...
                                      value={payDate}
                                      onChange={(e) => setPayDate(e.target.value)}
                                      style={{ ...payFormInputStyle, width: '140px' }}
                                    />
                                  </div>
                                  <div>
                                    <label
                                  ...
                                  <div style={{ display: 'flex', gap: '8px' }}>
                                    ...
                                    <button
                                      ...
                                      style={{
                                        ...
                                        borderRadius: 'var(--radius-md)',
                                        cursor:
                                          paySaving || !payAccountId ? 'not-allowed' : 'pointer',
                                        opacity: paySaving || !payAccountId ? 0.5 : 1,
                                      }}
                                    >
                                      {paySaving ? 'Salvando...' : 'Confirmar'}
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div>
                  ...
                  {['Devolvida ao estoque', 'Credito para o cliente', 'Perda/estrago', 'Outro'].map(
                    (opt) => (
                      <label
                        key={opt}
                        style={{
                      ...
                      >
                        <input
                          ...
                          name="merchandise"
                          value={opt}
                          checked={cancelMerchandise === opt}
                          onChange={(e) => setCancelMerchandise(e.target.value)}
                          style={{
                ...
                <div>
                  ...
                  {['Devolvido', 'Credito para o cliente', 'Estorno em cartao', 'Outro'].map(
                    (opt) => (
                      <label
                        key={opt}
                        style={{
                      ...
                      >
                        <input
                          ...
                          name="money"
                          value={opt}
                          checked={cancelMoney === opt}
                          onChange={(e) => setCancelMoney(e.target.value)}
                          style={{
                            accentColor: 'var(--color-primary-600)',
                            width: '18px',
                            height: '18px',
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 'var(--radius-md)',
                    cursor:
                      !cancelMerchandise || !cancelMoney || cancelling ? 'not-allowed' : 'pointer',
